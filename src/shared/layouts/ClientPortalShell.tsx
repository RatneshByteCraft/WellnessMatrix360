...
export function ClientPortalShell(){
 return <div className="portal-shell">
  <header className="portal-top"><div className="portal-brand"><div className="brand-mark">MP</div><div><strong>Medixpro360-Rehab</strong><small>My Wellness Portal</small></div></div><div className="portal-user"><span>Kabir Mehra</span><div className="avatar">KM</div><button className="icon-btn"><LogOut size={18}/></button></div></header>
